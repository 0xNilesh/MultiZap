...
export const starknetFactoryAbi = [
  {
    type: "function",
    name: "deploy_escrow",
    inputs: [
...
export const starknetEscrowAbi = [
  {
    type: "function",
    name: "claim",
    inputs: [{ name: "secret", type: "ByteArray" }],
    outputs: []
  },
  {
    type: "function",
...
export const starknetErc20Abi = [
    {
      "type": "impl",
      "name": "MockERC20",
      "interface_name": "starknet_htlc::mocks::mock_erc20::MockERC20::IMockERC20"
    },
    {
      "type": "struct",
    ...
    {
      "type": "interface",
      "name": "starknet_htlc::mocks::mock_erc20::MockERC20::IMockERC20",
      "items": [
        {
          "type": "function",
          "name": "mint",
    ...
    {
      "type": "event",
      "name": "starknet_htlc::mocks::mock_erc20::MockERC20::Event",
      "kind": "enum",
      "variants": [
        {
          "name": "ERC20Event",
